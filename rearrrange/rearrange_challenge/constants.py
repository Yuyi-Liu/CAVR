...
STARTER_DATA_DIR = os.path.join(
    os.path.abspath(os.path.dirname(os.path.dirname(Path(__file__)))), "data",
)

OTHER_INFO_DIR = os.path.join(
    os.path.abspath(os.path.dirname(os.path.dirname(Path(__file__)))), "otherInfo",
)
...
if __name__ == '__main__':
    print(len(REARRANGE_SIM_OBJECTS))
